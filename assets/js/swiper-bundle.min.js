        ...
        le = {
            onHashCange: function() {
                var e = this,
                    t = r();
                e.emit("hashChange");
                var a = t.location.hash.replace("javascript:void(0);", "");
            ...
            setHash: function() {
                ...
                if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && t.history && t.history.replaceState) t.history.replaceState(null, null, "javascript:void(0);" + e.slides.eq(e.activeIndex).attr("data-hash") || ""), e.emit("hashSet");
                    else {
            ...
            init: function() {
                ...
                if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                    ...
                    var i = t.location.hash.replace("javascript:void(0);", "");
                    if (i)
